...
Preprocessing is a way of gaining access to important features that vanilla CSS doesn't offer; such as variables and mixins.

2. What is your favorite concept in preprocessing? What is the concept that gives you the most trouble?

Mixins are my favorite because they're similar to functions in other languages and make styling a website faster. Less functions are giving me the most trouble because I haven't spent enough time in the documentation.

3. How would you explain the concept of a variable to someone new to programming?

Variables in less allow you to set a single value, such as a color or size, that may apply to several different elements. In doing so you're able to update that single value later and have an impact on all related elements.

4. What is the purpose of using functions in code?

Functions allow logic like if statements and also important math operations.

5. What is a JSON data?

It's data that's easy to read and follows Javascript's object rules; JSON literally meaning "JavaScript Object Notation."
